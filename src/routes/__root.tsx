...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "US Project Health Dashboard" },
      { name: "description", content: "Azure Boards delivery intelligence and RAG project health." },
      { property: "og:title", content: "US Project Health Dashboard" },
      { property: "og:description", content: "Azure Boards delivery intelligence and RAG project health." },
